package com.juliana212102441.forex;
...
public class MainActivity extends AppCompatActivity {
    private ProgressBar loadingProgressBer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingProgressBer = (ProgressBar)findViewById(R.id.loadingProgressBar);
    ...
    private void initForex(){
        loadingProgressBer.setVisibility(TextView.VISIBLE);

        String url = "https://openexchangerates.org/api/latest.json?app_id=3e42763c82e9457c84effa92711bd7a2";
        ...
        asyncHttpClient.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                loadingProgressBer.setVisibility(TextView.INVISIBLE);
            }
